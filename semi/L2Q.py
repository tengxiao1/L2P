...
parser.add_argument('--weight_decay', type=int, default=4)
...
parser.add_argument('--dataset', type=str, default='Cora')  # Cora PubMed CiteSeer # cs physics  computers  photo
...
parser.add_argument('--entropy', type=int, default=3)
...
# checkpt_file = '%s%sresultpiTgetT_'% (args.laynumber,args.taskType) + args.dataset + '_ConcatbestTest_%s' % bigest_test + '_H0alpha%s_entropy%s_alpha%s_weight_decay%s_hidden%s_dropout%s' % (
